...
namespace Services.Shared.Context
{
    public sealed class UserContext : IUserContext
    {
            ...
            get
            {
                ...
                )
                {
                    string userId = _contextAccessor
                        .HttpContext.User.Claims.FirstOrDefault(type =>
                            type.Type == nameof(RoleClaims.UserId)
                        )!
                        .Value;
                    if (userId != null)
                        return (userId, true);
        ...
        public (string Value, bool Exist) UserType
        {
            get
            {
                if (
                ...
                {
                    string userType = _contextAccessor
                        .HttpContext.User.Claims.FirstOrDefault(type =>
                            type.Type == nameof(RoleClaims.UserType)
                        )!
                        .Value;
                    if (userType != null)

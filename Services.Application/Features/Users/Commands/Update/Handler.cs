...
{
	public sealed class UpdateUserHandler : IRequestHandler<UpdateUserCommand, ResponseOf<UpdateUserResult>>
	{
		...
		public UpdateUserHandler(IUserRepository userRepository, IUnitOfWork unitOfWork, IEmailSender emailSender, ITokenRepository tokenRepository, IJWTManager jwtManager, IPasswordHasher<User> passwordHasher)
		{
		...
		public async Task<ResponseOf<UpdateUserResult>> Handle(UpdateUserCommand request, CancellationToken cancellationToken)
		{

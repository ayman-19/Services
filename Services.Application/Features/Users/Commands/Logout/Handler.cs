...
namespace Services.Application.Features.Users.Commands.Logout
{
	public sealed class LogoutUserHandler : IRequestHandler<LogoutUserCommand, Response>
	{
		...
		public LogoutUserHandler(ITokenRepository tokenRepository, IUnitOfWork unitOfWork, IUserContext userContext)
		{
		...
		public async Task<Response> Handle(LogoutUserCommand request, CancellationToken cancellationToken)
		{

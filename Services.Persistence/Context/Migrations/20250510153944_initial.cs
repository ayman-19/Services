    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SCHED_NAME = table.Column<string>(
                        type: "nvarchar(120)",
                        maxLength: 120,
                        nullable: false
                    ),
                    CALENDAR_NAME = table.Column<string>(
                        type: "nvarchar(200)",
                        maxLength: 200,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ENTRY_ID = table.Column<string>(
                        type: "nvarchar(140)",
                        maxLength: 140,
                        nullable: false
                    ),
                    TRIGGER_NAME = table.Column<string>(
                        type: "nvarchar(150)",
                        maxLength: 150,
                        nullable: false
                    ),
                    TRIGGER_GROUP = table.Column<string>(
                        type: "nvarchar(150)",
                        maxLength: 150,
                        nullable: false
                    ),
                    INSTANCE_NAME = table.Column<string>(
                        type: "nvarchar(150)",
                        maxLength: 150,
                        nullable: false
                    ),
                    ...
                    JOB_NAME = table.Column<string>(
                        type: "nvarchar(150)",
                        maxLength: 150,
                        nullable: true
                    ),
                    JOB_GROUP = table.Column<string>(
                        type: "nvarchar(150)",
                        maxLength: 150,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JOB_CLASS_NAME = table.Column<string>(
                        type: "nvarchar(250)",
                        maxLength: 250,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TRIGGER_STATE = table.Column<string>(
                        type: "nvarchar(16)",
                        maxLength: 16,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CRON_EXPRESSION = table.Column<string>(
                        type: "nvarchar(120)",
                        maxLength: 120,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    STR_PROP_1 = table.Column<string>(
                        type: "nvarchar(512)",
                        maxLength: 512,
                        nullable: false
                    ),
                    STR_PROP_2 = table.Column<string>(
                        type: "nvarchar(512)",
                        maxLength: 512,
                        nullable: false
                    ),
                    STR_PROP_3 = table.Column<string>(
                        type: "nvarchar(512)",
                        maxLength: 512,
                        nullable: false
                    ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "QRTZ_CALENDARS", schema: "dbo");

            migrationBuilder.DropTable(name: "QRTZ_CRON_TRIGGERS", schema: "dbo");

            migrationBuilder.DropTable(name: "QRTZ_FIRED_TRIGGERS", schema: "dbo");

            migrationBuilder.DropTable(name: "QRTZ_LOCKS", schema: "dbo");

            migrationBuilder.DropTable(name: "QRTZ_PAUSED_TRIGGER_GRPS", schema: "dbo");

            migrationBuilder.DropTable(name: "QRTZ_SCHEDULER_STATE", schema: "dbo");

            migrationBuilder.DropTable(name: "QRTZ_SIMPLE_TRIGGERS", schema: "dbo");

            migrationBuilder.DropTable(name: "QRTZ_SIMPROP_TRIGGERS", schema: "dbo");

            migrationBuilder.DropTable(name: "RolePermission", schema: "Identity");

            migrationBuilder.DropTable(name: "Token", schema: "Identity");

            migrationBuilder.DropTable(name: "UserRole", schema: "Identity");

            migrationBuilder.DropTable(name: "WorkerService", schema: "Service");

            migrationBuilder.DropTable(name: "Customer", schema: "Service");

            migrationBuilder.DropTable(name: "QRTZ_TRIGGERS", schema: "dbo");
            ...
            migrationBuilder.DropTable(name: "Worker", schema: "Service");

            migrationBuilder.DropTable(name: "QRTZ_JOB_DETAILS", schema: "dbo");

            migrationBuilder.DropTable(name: "Category");

            migrationBuilder.DropTable(name: "Discount", schema: "Service");

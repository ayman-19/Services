...
namespace Services.Persistence.Context.Migrations
{
    ...
    [Migration("20250610221142_disRuleupdate")]
    partial class disRuleupdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Services.Domain.Entities.DiscountRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DiscountRule", "Service");
                });

            modelBuilder.Entity("Services.Domain.Entities.Point", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Services.Domain.Entities.Point", b =>
                {
                    b.HasOne("Services.Domain.Entities.Customer", "Customer")
                        .WithOne("Point")
                        .HasForeignKey("Services.Domain.Entities.Point", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
